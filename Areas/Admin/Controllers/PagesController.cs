...
namespace LunarSports.Areas.Admin.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        public PagesController(LunarSportsDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        // [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Description,DatePublished,DateModified,IsVisible")] Page page)
        {
            if (id != page.ID)
            {
                return NotFound();
