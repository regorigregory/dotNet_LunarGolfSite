    ...
    public class NextOfKinsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var nextOfKin = await _context.NextOfKins
                .FirstOrDefaultAsync(m => m.NextOfKinID == id);
            if (nextOfKin == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("NextOfKinID,FirstName,LastName,RelationShip,ContactDetailID")] NextOfKin nextOfKin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NextOfKinID,FirstName,LastName,RelationShip,ContactDetailID")] NextOfKin nextOfKin)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!NextOfKinExists(nextOfKin.NextOfKinID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.NextOfKins.Any(e => e.NextOfKinID == id);
        }
    }
}
